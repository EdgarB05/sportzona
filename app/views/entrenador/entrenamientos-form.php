...
<head>
    <meta charset="UTF-8">
    <title>Crear Entrenamiento | SportZona</title>
...
<main class="main-content">
    ...
    <div class="form-container">
        ...
        <form action="index.php?controller=entrenamientos&action=store" method="POST">

            <label class="label">Nombre de rutina</label>
            <input type="text" name="nombreRutina" class="input" required>

            <label class="label">Descripción</label>
            <textarea name="descripcionEje" rows="3"></textarea>
