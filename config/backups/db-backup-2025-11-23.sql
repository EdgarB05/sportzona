...
CREATE TABLE `cita` (
  ...
  KEY `idCoach` (`idCoach`),
  CONSTRAINT `cita_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `usuarios` (`idUsuario`) ON DELETE CASCADE,
  CONSTRAINT `cita_ibfk_2` FOREIGN KEY (`idCoach`) REFERENCES `coach` (`idCoach`) ON DELETE SET NULL
...
INSERT INTO `cuestionario_alimentacion` VALUES("2","5","0","Juan Gaga García","20","80.00","1.80","Aumentar masa muscular","dsfghjkl","Futbol ","5","3.0","2","de 6 de la tarde a 9 de la noche","ninguna","3","fghjklñ","2","ghjkl","el chocolate","fghjklñ","no","me despierto a las 5 y me duermo a las 12","2025-11-10 22:23:54");
INSERT INTO `cuestionario_alimentacion` VALUES("3","2","0","Edgar Eduardo Beltran Garcia","19","60.00","99.99","Aumentar masa muscular","jhgfdfsd","jhgfdd","5","0.0","0","","","0","","0","","","","","","2025-11-17 01:10:46");
...
INSERT INTO `membresia` VALUES("18","7","1","2025-10-23","2025-11-23","activa","1","2025-11-21 12:05:09","2025-11-22 18:13:25");
...
CREATE TABLE `planalimentacion` (
  `idPlanAlimentacion` int(11) NOT NULL AUTO_INCREMENT,
  `nombrePlan` varchar(255) NOT NULL,
  `fechaIni` date NOT NULL,
  `caloríasTota` float NOT NULL,
  `objetivoUsu` varchar(255) NOT NULL,
  `idUsuario` int(11) DEFAULT NULL,
  `idCoach` int(11) DEFAULT NULL,
  PRIMARY KEY (`idPlanAlimentacion`),
  KEY `idUsuario` (`idUsuario`),
  KEY `idCoach` (`idCoach`),
  CONSTRAINT `idCoach` FOREIGN KEY (`idCoach`) REFERENCES `coach` (`idCoach`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `usuarios` VALUES("1","Alexandra","Beltran","Garcia","Femenino","777-283-5338","alex@gmail.com","$2y$10$rwGrh1DhsmRaQUuDX/vdWubKYX0uf3TI.R67BN2bWQwG9o8k/S3HK","2025-11-09","cliente","0","0","");
INSERT INTO `usuarios` VALUES("2","Edgar","Beltran","Garcia","Masculino","777-283-5338","EdBeltran@gmail.com","$2y$10$zRY97gjo4hlSkK5rn1gnS.tmWUgpL9C6VNShI0s55bHyWFkdGbFam","2025-11-09","cliente","0","0","");
INSERT INTO `usuarios` VALUES("3","Eduardo","Garcia","Garcia","Masculino","777-283-5338","edu@gmail.com","$2y$10$5sQGvwcmXImv3eTnhbn7Ru07gAmxMFUFz/yuK19qmnV7FdCEtHG1C","2025-11-09","cliente","0","0","");
INSERT INTO `usuarios` VALUES("4","Juan","Beltran","Garcia","Masculino","777-526-9602","juan@gmail.com","$2y$10$.ubHf6eUtR1QnCrwTPUHy.cYeBL2J59teGVe0Ds2BZmfn03l.MalS","2025-11-10","cliente","0","0","");
INSERT INTO `usuarios` VALUES("5","Juan","Gaga","Garcia","Masculino","777-526-9602","juan34@gmail.com","$2y$10$ti91RQbg6zhJYshYzagwHeiTI.e7a2y/uYlv51mbL8fBNrS.Vb5fy","2025-11-10","cliente","0","0","");
INSERT INTO `usuarios` VALUES("7","Edgar Eduardo","Beltran","Garcia","Masculino","777-283-5338","misalalobg@gmail.com","$2y$10$oBUiEOLzB.6LxeSwjWULwePfPZMjj9mKfBFc1/fFk5BhNYqOhuX/u","2025-11-18","cliente","0","0","");
INSERT INTO `usuarios` VALUES("9","Yesenia","Garcia","Sotelo","Femenino","777-283-5338","ndrusian1123@gmail.com","$2y$10$oZnNCY21yx2xnctgqA9ZrO0cZUGpKbykkTEj6mqoznU0FkZN5hsde","2025-11-22","cliente","","","");
